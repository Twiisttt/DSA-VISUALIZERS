...
function Stack() {
 ...
 function pushElement() {
  if (inputValue.trim() === "") {
    setMessage("Enter a value before pushing.");
    setOperationType("error");
    return;
  }

  setStack([...stack, inputValue]);
  setMessage(`${inputValue} was pushed onto the stack.`);
...
function popElement() {
  if (stack.length === 0) {
    setMessage("Cannot pop because the stack is empty.");
    setOperationType("error");
    return;
  }
  ...
  setMessage(`${topElement} was removed from the top.`);
  setOperationType("pop");
}

function peekElement() {
  if (stack.length === 0) {
    setMessage("Cannot peek because the stack is empty.");
    setOperationType("error");
    return;
  }
  ...
  setMessage(`The current top element is ${topElement}.`);
  setOperationType("peek");
}

function clearStack() {
  setStack([]);
  setMessage("All elements were removed from the stack.");
  ...
  return (
    <div className="stack-page">
     ...
     <div className={`operation-message ${operationType}`}>
  ...
  <div className="operation-details">
    <span>
      {operationType === "push" && "PUSH OPERATION"}
      {operationType === "pop" && "POP OPERATION"}
      {operationType === "peek" && "PEEK OPERATION"}
      {operationType === "clear" && "STACK CLEARED"}
    ...
    <p>{message}</p>
      ...
      <div className="stack-content">
        ...
        <div className="stack-info">
          ...
          <p>
            Stack follows <strong>LIFO</strong> —
            Last In, First Out.
          </p>
